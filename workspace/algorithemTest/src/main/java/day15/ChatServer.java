...
class ChatThread extends Thread {
    ...
    private Map<String, Map<String,PrintWriter>> roomMap; // 1번방 2번방    roomMap[1].put roomMap[2].put
...
//            out.flush();
        ...
        synchronized (chatClients){
           ...
           while (it.hasNext()){
               ...
               try {
                   ...
                   it.remove(); //브로드케스트 할 수 없는 사용자 제거
                   e.printStackTrace();
               }
           }
        }
    ...
    public void sendMsg(String msg){
        ...
        int secondSpaceIndex = msg.indexOf(" ", firstSpaceIndex +1 ); //첫번째 공백+1 을 시작지점 기준으로 공백을 찾아라
        if ((secondSpaceIndex) == -1) //공백이 없다면...
            return;
